            ...
            <main id="page-home" class="home">
               <section class="home__hero c-white hero p-r">
                  <div
                     class="home__hero__bg hero__bg bg-img absolute-full"
                     data-kira-item="parallaxTop"
                     data-bg="assets/img/bg1.jpg"
                     data-bg-hidpi="assets/img/bg1.jpg"
                     ></div>
                  <div
                     class="home__hero__top hero__top hero__section d-f ai-center jc-center p-r ta-c"
                     data-kira-timeline="onload"
                     >
                     <div class="container">
                        <h1
                           class="home__hero__title title-xxl tt-u mb-lg"
                           data-kira-item="splitline"
                           data-splittext="lines, words, chars"
                           data-start="0.2"
                           >
                           AESTHETIC, Jordan<br />
                           Dr. Omar Yousef
                        ...
                        <p
                           class="home__hero__text hero__text fs-md md-up-fs-lg lh-md mb-md md-up-mb-xl"
                           data-kira-item="fadeInUp"
                           data-start="-=1"
                           ></p>
                        <a
                           class="home__hero__link btn"
                  ...
                  <div
                     class="home__hero__bottom hero__section d-f ai-center jc-center"
                     data-kira-timeline
                     >
                     <div class="container">
                        <div class="row">
                           <div class="col-lg-9 col-hd-8 offset-hd-1">
                              <h2
                                 class="home__hero__subtitle title-xxl tt-u"
                                 data-kira-item="splitline"
                                 data-splittext="lines, words, chars"
                                 data-start="0.2"
                                 >
                           ...
                           <div class="col-lg-14 col-xl-13 offset-lg-1">
                              <p
                                 class="home__hero__subtext fs-lg fw-100 letter-xl"
                                 data-kira-item="fadeInUp"
                                 data-start="-=1"
                                 >
                     ...
                     <div class="row">
                        <div class="col-md-6 mb-md">
                           <a class="home__surgery__page d-b p-r o-h" href="#">
                              <div
                                 id="img-15702"
                                 class="lazy-image home__surgery__img"
               ...
               <section class="home__medecine p-r o-h" data-kira-timeline>
                  <div class="container ta-c">
                     <h2
                        class="home__medecine__title title-xxl tt-u mb-md md-up-mb-xl"
                        >
                        Home Page
                     </h2>
                  </div>
                  <div
                     class="home__medecine__marquee home__medecine__marquee--top marquee"
                     >
                  ...
                  <div class="home__medecine__top container">
                     <div class="row h-100 no-gutters">
                        <div
                           class="home__medecine__pushTop home__medecine__pushTop--left col-md-12 col-xl-9 bg-beige p-r"
                           >
                           <div
                              class="home__medecine__pushTopInner d-f fd-column h-100 p-r"
                              >
                        ...
                        <div
                           class="home__medecine__img col-md-8 md-up-d-none xl-up-d-b o-h p-r"
                           >
                           <div
                              class="bg-cover absolute-full"
                              data-kira-item="zoomOut"
                  ...
                  <div
                     class="home__medecine__marquee home__medecine__marquee--bottom marquee"
                     data-direction="1"
                     >
                     <div class="marquee__inner d-f ai-center">
                        <div class="marquee__sentence">
                  ...
                  <div class="home__medecine__bottom container p-r">
                     <div class="home__medecine__pushBottom row no-gutters c-white">
                        <div class="col-left px-0 p-r">
                           <div
                              class="home__medecine__pushBottomInner p-r d-f fd-column h-100"
                              >
                        ...
                        <div class="col-right p-0 p-r">
                           <div class="home__medecine__pushBottomImg p-r o-h">
                              <div
                                 class="bg-cover absolute-full"
                                 data-kira-item="zoomOut"
                                 data-bg="assets/img/homepage/homepage7.jpg"
                                 ></div>
                           </div>
                        </div>
                     </div>
                        ...
                        <div class="col-right p-0 p-r">
                           <div class="home__medecine__pushBottomImg p-r o-h">
                              <div
                                 class="bg-cover absolute-full"
                                 data-kira-item="zoomOut"
                                 data-bg="assets/img/homepage/homepage8.jpg"
                                 ></div>
                           </div>
                        </div>
                     </div>
